...
class Camera:
  ...
  radial_distortion: ArrayLike | None = _camera_field((4,), default=None)
  tangential_distortion: ArrayLike | None = _camera_field((2,), default=None)
...
def crop(
    camera: Camera,
    left: int | ArrayLike = 0,
    right: int | ArrayLike = 0,
    top: int | ArrayLike = 0,
    bottom: int | ArrayLike = 0,
) -> Camera:
